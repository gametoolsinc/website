...
class Webpage
{
    ...
    function __construct(array $colours=["#8bcdd9", "#6dadcf"])
    {
        ...
        $this->addStylesheet("/library/template/webpage/stylesheet.css");
        $this->addJavascript("/module/analytics/views.js");
    ...
    {
        $html = file_get_contents($_SERVER['DOCUMENT_ROOT'] . "/library/template/webpage/webpage.html");
