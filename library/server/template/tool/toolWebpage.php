...
include_once($_SERVER['DOCUMENT_ROOT'] . "/module/explanation/explanation.php");
...
class ToolWebpage
{
    ...
    function __construct(int $tool_id)
    {
        ...
        $this->webpage->addStylesheet("/library/server/template/tool/stylesheet.css");
        $this->webpage->addStylesheet($this->tool->getApplication()->getStylesheetUrl());
        $this->webpage->addStylesheet("/library/client/tooltip/tooltip.css");
        ...
        $this->webpage->addJavascript("/library/client/tooltip/tooltip.js");
    ...
    function endContent()
    {
        ...
        $explanation = new Explanation($this->webpage);
